  ...
  <div class="row d-flex justify-content-center mt-4 mx-5">
    <div class="col-10">
      <div class="card border-primary mb-3">
        <div class="card-header fw-bold">Data Dokter</div>
        <div class="card-body">
          <h5 class="card-title"><a href="../pegawai_data/tambah.php" class="btn btn-primary">Tambah Data</a></h5>
          <h5 class="card-title"><a href="../laporan/laporan_pegawai.php" class="btn btn-primary">Cetak Data Pegawai</a></h5>
          <?php
          if (isset($_GET['pesan'])) {
          ...
          <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
              <?php
              $query = "SELECT * FROM pegawai WHERE jabatan LIKE '%dokter%' ORDER BY nama_pegawai ASC";
